...
func TestUpperOrLowerCase(t *testing.T) {
	...
	assert.Equal(t, "ABC", Uppercase("abc"))
	assert.Equal(t, "abc", Lower("ABC"))
	assert.Equal(t, "abc", Lowercase("ABC"))
}
...
func TestUpperFirst(t *testing.T) {
	...
	for _, tt := range tests {
		assert.Equal(t, tt.want, UpperFirst(tt.give))
	}
}
...
func TestLowerFirst(t *testing.T) {
	...
	for _, tt := range tests {
		assert.Equal(t, tt.want, LowerFirst(tt.give))
	}
}
...
func TestUpperWord(t *testing.T) {
	...
	for _, tt := range tests {
		assert.Equal(t, tt.want, UpperWord(tt.give))
	}
}
...
func TestCamelCase(t *testing.T) {
	...
	is.Equal("中文Try", CamelCase("中文 try", " "))
